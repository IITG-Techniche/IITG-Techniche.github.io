...
const cities = {
    ...
    Lakshadweep: ["Agatti Island","Amini","Andrott","Bitra Island","Chetlat Island","Kadmat Island","Kalpeni","Kavaratti","Kiltan","Minicoy"],
...
function populateStates() {
    ...
    stateDropdown.options.length = 1;
...
function handleCountryChange() {
    ...
    if (stateInput) {
        stateInput.parentNode.removeChild(stateInput);
    }
    ...
    if (countrySelect.value === "India") {
        ...
        stateSelect.parentNode.insertBefore(stateInput, stateSelect);
        citySelect.parentNode.insertBefore(cityInput, citySelect);
    }
}
